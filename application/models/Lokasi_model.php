...
class Lokasi_model extends CI_Model {
    ...
    public function get_all_lokasi($url) {
        $response = file_get_contents($url);
        return json_decode($response, true);
    }

    public function get_lokasi($url, $id) {
        $response = file_get_contents($url . '/' . $id);
        return json_decode($response, true);
    }

    public function insert_lokasi($url, $data) {
        $options = array(
            'http' => array(
    ...
    public function update_lokasi($url, $id, $data) {
        $options = array(
            'http' => array(
                'header'  => "Content-Type: application/json\r\n",
                'method'  => 'PUT',
    ...
    public function delete_lokasi($url, $id) {
        $options = [
            'http' => [
                'method' => 'DELETE',
            ],
