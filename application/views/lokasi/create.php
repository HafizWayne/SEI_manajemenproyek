...
<div class="container mx-auto p-6">
    <!-- Judul -->
    <h1 class="text-3xl font-bold text-gray-800 mb-8 text-center">Tambah Lokasi Baru</h1>
    
    <!-- Formulir -->
    <form action="<?php echo site_url('lokasi/store'); ?>" method="post" class="bg-white p-8 rounded-lg shadow-md max-w-4xl mx-auto">
